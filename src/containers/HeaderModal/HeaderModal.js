...
const mapDispatchToProps = (dispatch) => ({
  ...
  signIn: (data) => dispatch(authActions.signIn(data, () => dispatch(headerModalActions.closeModal())))
});

export default connect(mapStateToProps, mapDispatchToProps)(HeaderModalContainer);